Describe 'Check-Dependencies script' {
    It 'reports dependency status for all modules' {
        ...
        $expected = 'Pester','PnP.PowerShell','ExchangeOnlineManagement','Microsoft.Graph','ActiveDirectory','Microsoft.PowerShell.SecretManagement','Microsoft.PowerShell.SecretStore'
